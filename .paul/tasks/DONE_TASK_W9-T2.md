...
### Attempt 1
- Date: 2026-05-23
- Result: Created skills/tcr-info/SKILL.md with 4 steps: load config, show config, query _index_meta tables for indexed projects, print command reference. All error cases handled (no config, no DB URL, connection error).
- Files Changed: skills/tcr-info/SKILL.md (created)
- Issues: none
- Status: DONE
