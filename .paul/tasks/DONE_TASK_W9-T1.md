...
### Attempt 1
- Date: 2026-05-23
- Result: Created skills/tcr-config/SKILL.md with 5-step config wizard. Covers setup mode (first run), change mode (existing config), and reset. Config JSON schema matches spec.
- Files Changed: skills/tcr-config/SKILL.md (created)
- Issues: none
- Status: DONE
