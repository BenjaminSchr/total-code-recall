...
### Attempt 1
- Date: 2026-05-23
- Result: Created scripts/setup_db.sql with exact content from Pattern section — CREATE EXTENSION vector, CREATE TABLE _index_meta with all columns, and project table template as comment.
- Files Changed: scripts/setup_db.sql
- Issues: none
- Status: DONE
