...
### Attempt 1
- Date: 2026-05-23
- Result: Removed TCR_HEAD_MESSAGE shell env var from both skill files. Changed tcr_chunks.json structure to include meta.head_message wrapper. Updated tcr_index.py in both skills to read HEAD_MESSAGE from data["meta"]["head_message"] instead of os.environ. Removed TCR_HEAD_MESSAGE from both bash invocation lines.
